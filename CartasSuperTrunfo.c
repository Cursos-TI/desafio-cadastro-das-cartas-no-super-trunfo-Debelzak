...
int main() {
    ...
    float carta1_densidade_polulacional, carta2_densidade_polulacional;
    ...
    carta1_densidade_polulacional = (float)carta1_populacao / carta1_area;
    carta1_super_poder = carta1_populacao + carta1_area + carta1_pib + carta1_pib_per_capita + ((float)1 / carta1_densidade_polulacional) + carta1_pontos_turisticos;
    ...
    carta2_densidade_polulacional = (float)carta2_populacao / carta2_area;
    carta2_super_poder = carta2_populacao + carta2_area + carta2_pib + carta2_pib_per_capita + ((float)1 / carta2_densidade_polulacional) + carta2_pontos_turisticos;
    ...
    printf("- Vencedor em Densidade Populacional: Carta %d\n", (carta1_densidade_polulacional < carta2_densidade_polulacional)+1);
    ...
    return 0; //TWUgZMOhIHVtYSBtb3JhbC4gRG9ldSBtdWl0byBzw7MgdXNhciBvIHF1ZSB0w6EgbmFzIGF1bGFzLg==
}